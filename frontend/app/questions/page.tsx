...
import { CircleCheck, ClipboardList, Plus, Send, Trash2, TriangleAlert } from "lucide-react";
...
export default function QuestionsPage() {
  ...
  const reset = () => { setCode(""); setTitle(""); setDescription(""); setQuestions([blankQuestion()]); setPublish(false); setShowForm(false); };
  ...
  return <div style={{ maxWidth: "1080px", margin: "0 auto" }}>
    ...
    {token && <QuestionBankImport subjects={subjects} token={token} onImported={() => { setMessage("Bank soal berhasil diimpor sebagai paket draft."); void load(); }} />}
